...
public class Car implements Vehicle {
    ...
    public void setModelNameByName(String oldModelName, String newModelName) throws NoSuchModelNameException {
        getModelByName(newModelName).modelName = newModelName;
    }
