...
public class Car {
    ...
    public Car(String markName, int marraySize) {
        ...
        for(int i = 1; i < marray.length; i++) {
            marray[i] = new Model(getRandName(), Math.random());
        }
    }
    ...
    public Model getElementByName(String modelName) {
        int i;
    ...
    public double getModelCostByName(String modelName) {
        return getElementByName(modelName).modelCost;
    }

    public void setModelCostByName(String modelName, double modelCost) {
        getElementByName(modelName).modelCost = modelCost;
    }
